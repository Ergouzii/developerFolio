    ...
    <Fade bottom duration={1000} distance="20px">
      ...
      <div className="row">
        <div className="main-content-profile">
            ...
            <div>
              <span className="desc-prof">Open to relocation in: Vancouver, Edmonton, Calgary, Toronto</span>
            </div>
            <div>
              <span className="desc-prof">Open for opportunities: {prof.hireable}</span>
            </div>
            {prof.email &&
              <div className="email-div desc-prof">
                <a className="email-link" href={"mailto:" + prof.email}>{prof.email}</a>
              </div>
            }
            <SocialMedia/>
          </div>
